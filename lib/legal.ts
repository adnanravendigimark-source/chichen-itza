...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Chichen Itza Tour & Tickets",
  metaDescription: "Privacy Policy for Chichen Itza Tour & Tickets — how we collect, use, and protect your information.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
